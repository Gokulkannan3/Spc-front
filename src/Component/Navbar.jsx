...
import { Home, Info, ShoppingCart, MapPin, ShieldCheck, PhoneCall, Menu, X, Hamburger } from "lucide-react"
            ...
            <div className="flex items-center justify-between">
              ...
              >
                <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center">
                  <Hamburger className="w-6 h-6 text-black" />
                </div>
              ...
              <button
                ...
                className="hidden lg:block px-8 py-3 bg-gradient-to-r from-amber-500 to-orange-600 text-black font-semibold rounded-2xl"
              >
                Order Now
              </button>
            </div>
        ...
        <AnimatePresence>
          {mobileOpen && reversed.map((item, ri) => {
            ...
            return (
              ...
              >
                <Icon size={22} />
                <span style={{ fontSize: "9px", fontWeight: 700, marginTop: 2 }}>{item.name}</span>
              </motion.button>
            )
          })}
        </AnimatePresence>
